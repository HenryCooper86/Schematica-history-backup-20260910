...
export default {
  ...
  '{label} at {capacity}: about {hours} h at {draw}, ignoring duty cycle and efficiency.': '{label} 容量 {capacity}：在 {draw} 下约可运行 {hours} 小时，未计占空比与效率。',
  ...
  'One more part on this rail declares no current.': '该电压轨上还有 1 个部件未声明电流。',
  '{n} more parts on this rail declare no current.': '该电压轨上还有 {n} 个部件未声明电流。',
  ...
  '{label} holds {capacity}; at {draw} that is about {hours} h, ignoring duty cycle and conversion efficiency.': '{label} 容量为 {capacity}；在 {draw} 下约可运行 {hours} 小时，未计占空比与转换效率。',
  // ---- RDK checks ----
